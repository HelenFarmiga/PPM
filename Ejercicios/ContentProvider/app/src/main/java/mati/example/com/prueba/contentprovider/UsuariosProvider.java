...
public class UsuariosProvider extends ContentProvider {
    ...
    public final static String AUTHORITY = "mati.example.com.prueba.contentprovider";
    private static final String uri = "content://" + AUTHORITY + "/" + ACTIVIDAD;
    public final static Uri CONTENT_URI = Uri.parse(uri);
    ...
    private UsuariosSqliteHelper usuariosHelper;
    ...
    public boolean onCreate() {
        usuariosHelper = new UsuariosSqliteHelper(getContext(), BD_NOMBRE, null, BD_VERSION);
        return true;
    }
    @Override
    public Cursor query(Uri uri, String[] proyeccion, String seleccion, String[] seleccionArgs, String ordenacion) {
        ...
        SQLiteDatabase sqliteDatabase = usuariosHelper.getWritableDatabase();
        Cursor cursor = sqliteDatabase.query(TABLA_USUARIOS, proyeccion, where, seleccionArgs, null, null, ordenacion);
        return cursor;
    }
    @Override
